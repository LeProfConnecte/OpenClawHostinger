          ...
          >
            <Card className="max-w-lg border-[#1f2022] bg-[#141416]/95 backdrop-blur-sm setup-card">
              ...
              <CardContent className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        placeholder={provider === 'openai' ? 'sk-...' : provider === 'openrouter' ? 'sk-or-...' : 'sk-ant-...'}
                ...
                {/* OpenRouter Model Input - Only show for openrouter provider */}
                {provider === 'openrouter' && (
                  <div className="space-y-2">
                    <Label htmlFor="openrouterModel" className="text-zinc-200">Model</Label>
                    <Input
                      id="openrouterModel"
                    ...
                    <p className="text-xs text-zinc-500">
                      Examples: <span className="text-zinc-400">openrouter/auto</span>, <span className="text-zinc-400">openrouter/anthropic/claude-sonnet-4</span>, <span className="text-zinc-400">openrouter/openai/gpt-4o</span>
                    </p>
                  </div>
                )}
